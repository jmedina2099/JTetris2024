...
public class CustomWebServerFactory extends NettyReactiveWebServerFactory {
	...
	private void init() {
		...
		this.logger.debug("===> FIGURES - connectionTimeout = " + connectionTimeout.toMinutes());
		this.logger.debug("===> FIGURES - idleTimeout = " + idleTimeout.toMinutes());
		this.logger.debug("===> FIGURES - readTimeout = " + readTimeout.toMinutes());
		this.logger.debug("===> FIGURES - writeTimeout = " + writeTimeout.toMinutes());
		...
		addServerCustomizers(httpServer -> httpServer.option(ChannelOption.AUTO_CLOSE, false)
				...
				.doOnChannelInit((connectionObserver, channel, remoteAddress) -> {
					...
					this.logger.debug("===============================> doOnConnected in FIGURES - conn.isPersistent ="
							+ conn.isPersistent());
